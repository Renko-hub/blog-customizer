...
import { fontSizeOptions, fontColors, backgroundColors, contentWidthArr, fontFamilyOptions, defaultArticleState } from 'src/constants/articleProps';
  ...
  return (
    <>
      ...
      <aside
        ...
        className={clsx(
          styles.container,
          openState && styles.container_open
        )}
      >
